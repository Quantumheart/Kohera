...
///
/// Call this wherever `User` objects are obtained from the SDK (room
/// participants, typing users, read receipt users) as
/// `const UserSummaryResolver()(user)`.
class UserSummaryResolver {
  const UserSummaryResolver();

  KoheraUserSummary call(User user) => KoheraUserSummary(
        userId: user.id,
